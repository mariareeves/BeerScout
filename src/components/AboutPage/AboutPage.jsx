    ...
    return (
        <div className={styles.about}>
            ...
            <p>We believe that beer is not just a drink, but a way of life. It brings people together, sparks conversations, and creates unforgettable memories. That's why we created BeerScout - to help you discover the best breweries around you, no matter where you are in the world.
                ...
                At BeerScout, we're all about the vibe. We know that the best breweries are more than just a place to drink - they're a community. That's why we're passionate about promoting breweries that go the extra mile to create a welcoming, inclusive atmosphere. We especially love breweries that welcome our furry friends - after all, what's better than enjoying a cold beer with your dog by your side?

                So what are you waiting for? Start exploring the world of beer with BeerScout today. Cheers!</p>
        </div>
    )
}